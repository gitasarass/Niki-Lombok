...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search_box" placeholder="search destinasi" maxlength="100" class="box" required>
...
<section class="products" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
     ...
     $select_destination = $conn->prepare("SELECT * FROM `products` WHERE name LIKE '%{$search_box}%'"); 
